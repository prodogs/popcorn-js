...
k)&&h.call(o,this[k],k,this);return this};if(!Array.prototype.map)Array.prototype.map=function(h,o){var n,k,s;if(this==null)throw new TypeError("this is null or not defined");var t=Object(this),y=t.length>>>0;if({}.toString.call(h)!="[object Function]")throw new TypeError(h+" is not a function");if(o)n=o;k=Array(y);for(s=0;s<y;){var u;if(s in t){u=t[s];u=h.call(n,u,s,t);k[s]=u}s++}return k};if(!Array.prototype.indexOf)Array.prototype.indexOf=function(h){if(this==null)throw new TypeError;var o=Object(this),
n=o.length>>>0;if(n===0)return-1;var k=0;if(arguments.length>0){k=Number(arguments[1]);if(k!=k)k=0;else if(k!=0&&k!=Infinity&&k!=-Infinity)k=(k>0||-1)*Math.floor(Math.abs(k))}if(k>=n)return-1;for(k=k>=0?k:Math.max(n-Math.abs(k),0);k<n;k++)if(k in o&&o[k]===h)return k;return-1};if(typeof String.prototype.trim!=="function")String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")}})();
...
0)d.media.currentTime=0;d.media.removeEventListener("loadedmetadata",l,false);var p,v,x,m,f;p=d.media.duration;p=p!=p?Number.MAX_VALUE:p+1;c.addTrackEvent(d,{start:p,end:p});if(d.options.frameAnimation){d.data.timeUpdate=function(){c.timeUpdate(d,{});c.forEach(c.manifest,function(j,J){if(v=d.data.running[J]){m=v.length;for(var E=0;E<m;E++){x=v[E];(f=x._natives)&&f.frame&&f.frame.call(d,{},x,d.currentTime())}}});d.emit("timeupdate");!d.isDestroyed&&B(d.data.timeUpdate)};!d.isDestroyed&&B(d.data.timeUpdate)}else{d.data.timeUpdate=
function(j){c.timeUpdate(d,j)};d.isDestroyed||d.media.addEventListener("timeupdate",d.data.timeUpdate,false)}};Object.defineProperty(this,"error",{get:function(){return d.media.error}});d.media.readyState>=1?l():d.media.addEventListener("loadedmetadata",l,false);return this}}};c.p.init.prototype=c.p;c.byId=function(a){for(var b=c.instances,e=b.length,d=0;d<e;d++)if(b[d].id===a)return b[d];return null};c.forEach=function(a,b,e){if(!a||!b)return{};e=e||this;var d,g;if(u&&a.forEach===u)return a.forEach(b,
...
c.Events.Natives=c.Events.UIEvents+" "+c.Events.MouseEvents+" "+c.Events.Events;C.events.apiTypes=["UIEvents","MouseEvents","Events"];(function(a,b){for(var e=C.events.apiTypes,d=a.Natives.split(/\s+/g),g=0,i=d.length;g<i;g++)b.hash[d[g]]=true;e.forEach(function(l){b.apis[l]={};for(var p=a[l].split(/\s+/g),v=p.length,x=0;x<v;x++)b.apis[l][p[x]]=true})})(c.Events,C.events);c.events={isNative:function(a){return!!C.events.hash[a]},getInterface:function(a){if(!c.events.isNative(a))return false;var b=
...
a.end<this.parent.data.trackEvents.previousUpdateTime&&this.parent.data.trackEvents.endIndex++};k.prototype.remove=function(a){if(a instanceof n)a=a.id;if(typeof a==="object"){this.where(a).forEach(function(m){this.removeTrackEvent(m._id)},this.parent);return this}var b,e,d;d=this.byStart.length;for(var g=0,i=0,l=[],p=[],v=[],x=[];--d>-1;){b=this.byStart[g];e=this.byEnd[g];if(!b._id){l.push(b);p.push(e)}if(b._id){b._id!==a&&l.push(b);e._id!==a&&p.push(e);if(b._id===a)i=g}g++}d=this.animating.length;
g=0;if(d)for(;--d>-1;){b=this.animating[g];b._id||v.push(b);b._id&&b._id!==a&&v.push(b);g++}i<=this.startIndex&&this.startIndex--;i<=this.endIndex&&this.endIndex--;this.byStart=l;this.byEnd=p;this.animating=v;d=this.parent.data.history.length;for(g=0;g<d;g++)this.parent.data.history[g]!==a&&x.push(this.parent.data.history[g]);this.parent.data.history=x};c.addTrackEvent=function(a,b){var e;if(!(b instanceof n)){if((b=new n(b))&&b._natives&&b._natives.type&&a.options.defaults&&a.options.defaults[b._natives.type]){e=
...
0)c.error("'"+a+"' is a protected function name");else{var d=typeof b==="function",g=["start","end","type","manifest"],i=["_setup","_teardown","start","end","frame"],l={},p=function(m,f){m=m||c.nop;f=f||c.nop;return function(){m.apply(this,arguments);f.apply(this,arguments)}};c.manifest[a]=e=e||b.manifest||{};i.forEach(function(m){b[m]=s(b[m]||c.nop,a)});var v=function(m,f){if(!f)return this;if(f.ranges&&c.isArray(f.ranges)){c.forEach(f.ranges,function(w){w=c.extend({},f,w);delete w.ranges;this[a](w)},
this);return this}var j=f._natives={},J="",E;c.extend(j,m);f._natives.type=f._natives.plugin=a;f._running=false;j.start=j.start||j["in"];j.end=j.end||j.out;if(f.once)j.end=p(j.end,function(){this.removeTrackEvent(f._id)});j._teardown=p(function(){var w=F.call(arguments),I=this.data.running[j.type];w.unshift(null);w[1]._running&&I.splice(I.indexOf(f),1)&&j.end.apply(this,w);w[1]._running=false;this.emit("trackend",c.extend({},f,{plugin:j.type,type:"trackend",track:c.getTrackEvent(this,f.id||f._id)}))},
j._teardown);j._teardown=p(j._teardown,function(){this.emit("trackteardown",c.extend({},f,{plugin:a,type:"trackteardown",track:c.getTrackEvent(this,f.id||f._id)}))});f.compose=f.compose||[];if(typeof f.compose==="string")f.compose=f.compose.split(" ");f.effect=f.effect||[];if(typeof f.effect==="string")f.effect=f.effect.split(" ");f.compose=f.compose.concat(f.effect);f.compose.forEach(function(w){J=c.compositions[w]||{};i.forEach(function(I){j[I]=p(j[I],J[I])})});f._natives.manifest=e;if(!("start"in
f))f.start=f["in"]||0;if(!f.end&&f.end!==0)f.end=f.out||Number.MAX_VALUE;if(!z.call(f,"toString"))f.toString=function(){var w=["start: "+f.start,"end: "+f.end,"id: "+(f.id||f._id)];f.target!=null&&w.push("target: "+f.target);return a+" ( "+w.join(", ")+" )"};if(!f.target){E="options"in e&&e.options;f.target=E&&"target"in E&&E.target}if(!f._id&&f._natives)f._id=c.guid(f._natives.type);if(f instanceof n){if(f._natives){f._id=f.id||f._id||c.guid(f._natives.type);if(f._natives._setup){f._natives._setup.call(this,
f);this.emit("tracksetup",c.extend({},f,{plugin:f._natives.type,type:"tracksetup",track:f}))}}this.data.trackEvents.add(f);n.start(this,f);this.timeUpdate(this,null,true);f._id&&c.addTrackEvent.ref(this,f)}else c.addTrackEvent(this,f);c.forEach(m,function(w,I){g.indexOf(I)===-1&&this.on(I,w)},this);return this};c.p[a]=l[a]=function(m,f){var j,J;if(m&&!f)f=m;else if(j=this.getTrackEvent(m)){J=f;var E={},w;for(w in j)if(z.call(J,w)&&z.call(j,w))E[w]=j[w];if(j._natives._update){this.data.trackEvents.remove(j);
if(z.call(f,"start"))j.start=f.start;if(z.call(f,"end"))j.end=f.end;n.end(this,j);d&&b.call(this,j);j._natives._update.call(this,j,f);this.data.trackEvents.add(j);n.start(this,j)}else{c.extend(j,f);this.data.trackEvents.remove(m);j._natives._teardown&&j._natives._teardown.call(this,j);c.removeTrackEvent.ref(this,m);if(d)v.call(this,b.call(this,j),j);else{j._id=j.id||j._id||c.guid(j._natives.type);if(j._natives&&j._natives._setup){j._natives._setup.call(this,j);this.emit("tracksetup",c.extend({},j,
...
l;i++)if(g[i]&&g[i]._natives&&g[i]._natives.type===b){g.splice(i,1);i--;l--}};c.compositions={};c.compose=function(a,b,e){c.manifest[a]=e||b.manifest||{};c.compositions[a]=b};c.plugin.effect=c.effect=c.compose;var L=/^(?:\.|#|\[)/;c.dom={debug:false,find:function(a,b){var e=null;b=b||o;if(a){if(!L.test(a)){e=o.getElementById(a);if(e!==null)return e}try{e=b.querySelector(a)}catch(d){if(c.dom.debug)throw Error(d);}}return e}};var r=/\?/,D={ajax:null,url:"",data:"",dataType:"",success:c.nop,type:"GET",
async:true,contentType:"application/x-www-form-urlencoded; charset=UTF-8"};c.xhr=function(a){a.dataType=a.dataType&&a.dataType.toLowerCase()||null;if(a.dataType&&(a.dataType==="jsonp"||a.dataType==="script"))c.xhr.getJSONP(a.url,a.success,a.dataType==="script");else{a=c.extend({},D,a);a.ajax=new XMLHttpRequest;if(a.ajax){if(a.type==="GET"&&a.data){a.url+=(r.test(a.url)?"&":"?")+a.data;a.data=null}a.ajax.open(a.type,a.url,a.async);a.type==="POST"&&a.ajax.setRequestHeader("Content-Type",a.contentType);
a.ajax.send(a.data||null);return c.xhr.httpData(a)}}};c.xhr.httpData=function(a){var b,e=null,d,g=null;a.ajax.onreadystatechange=function(){if(a.ajax.readyState===4){try{e=JSON.parse(a.ajax.responseText)}catch(i){}b={xml:a.ajax.responseXML,text:a.ajax.responseText,json:e};if(!b.xml||!b.xml.documentElement){b.xml=null;try{d=new DOMParser;g=d.parseFromString(a.ajax.responseText,"text/xml");if(!g.getElementsByTagName("parsererror").length)b.xml=g}catch(l){}}if(a.dataType)b=b[a.dataType];a.success.call(a.ajax,
b)}};return b};c.xhr.getJSONP=function(a,b,e){var d=o.head||o.getElementsByTagName("head")[0]||o.documentElement,g=o.createElement("script"),i=false,l=[];l=/(=)\?(?=&|$)|\?\?/;var p,v;if(!e){v=a.match(/(callback=[^&]*)/);if(v!==null&&v.length){l=v[1].split("=")[1];if(l==="?")l="jsonp";p=c.guid(l);a=a.replace(/(callback=[^&]*)/,"callback="+p)}else{p=c.guid("jsonp");if(l.test(a))a=a.replace(l,"$1"+p);l=a.split(/\?(.+)?/);a=l[0]+"?";if(l[1])a+=l[1]+"&";a+="callback="+p}window[p]=function(x){b&&b(x);
i=true}}g.addEventListener("load",function(){e&&b&&b();i&&delete window[p];d.removeChild(g)},false);g.src=a;d.insertBefore(g,d.firstChild)};c.getJSONP=c.xhr.getJSONP;c.getScript=c.xhr.getScript=function(a,b){return c.xhr.getJSONP(a,b,true)};c.util={toSeconds:function(a,b){var e=/^([0-9]+:){0,2}[0-9]+([.;][0-9]+)?$/,d,g,i;if(typeof a==="number")return a;typeof a==="string"&&!e.test(a)&&c.error("Invalid time format");e=a.split(":");d=e.length-1;g=e[d];if(g.indexOf(";")>-1){g=g.split(";");i=0;if(b&&
typeof b==="number")i=parseFloat(g[1],10)/b;e[d]=parseInt(g[0],10)+i}d=e[0];return{1:parseFloat(d,10),2:parseInt(d,10)*60+parseFloat(e[1],10),3:parseInt(d,10)*3600+parseInt(e[1],10)*60+parseFloat(e[2],10)}[e.length||1]}};c.p.cue=c.p.exec;c.protect={natives:function(a){return Object.keys?Object.keys(a):function(b){var e,d=[];for(e in b)z.call(b,e)&&d.push(e);return d}(a)}(c.p).map(function(a){return a.toLowerCase()})};c.forEach({listen:"on",unlisten:"off",trigger:"emit",exec:"cue"},function(a,b){var e=
c.p[b];c.p[b]=function(){if(typeof console!=="undefined"&&console.warn){console.warn("Deprecated method '"+b+"', "+(a==null?"do not use.":"use '"+a+"' instead."));c.p[b]=e}return c.p[a].apply(this,[].slice.call(arguments))}});h.Popcorn=c}else{h.Popcorn={isSupported:false};for(t="byId forEach extend effects error guid sizeOf isArray nop position disable enable destroyaddTrackEvent removeTrackEvent getTrackEvents getTrackEvent getLastTrackEventId timeUpdate plugin removePlugin compose effect xhr getJSONP getScript".split(/\s+/);t.length;)h.Popcorn[t.shift()]=
function(){}}})(window,window.document);
(function(h){var o=function(n,k){n=n||h.nop;k=k||h.nop;return function(){n.apply(this,arguments);k.apply(this,arguments)}};h.player=function(n,k){if(!h[n]){k=k||{};var s=function(t,y,u){u=u||{};var F=new Date/1E3,z=F,G=0,H=0,A=1,K=false,C={},B=typeof t==="string"?h.dom.find(t):t,q={};Object.prototype.__defineGetter__||(q=B||document.createElement("div"));for(var c in B)if(!(c in q))if(typeof B[c]==="object")q[c]=B[c];else if(typeof B[c]==="function")q[c]=function(r){return"length"in B[r]&&!B[r].call?
...
D){C[r]||(C[r]=[]);C[r].push(D);return D};q.removeEventListener=function(r,D){var a,b=C[r];if(b){for(a=C[r].length-1;a>=0;a--)D===b[a]&&b.splice(a,1);return D}};q.dispatchEvent=function(r){var D,a=r.type;if(!a){a=r;if(r=h.events.getInterface(a)){D=document.createEvent(r);D.initEvent(a,true,true,window,1)}}if(C[a])for(r=C[a].length-1;r>=0;r--)C[a][r].call(this,D,this)};q.src=y||"";q.duration=0;q.paused=true;q.ended=0;u&&u.events&&h.forEach(u.events,function(r,D){q.addEventListener(D,r,false)});if(k._canPlayType(B.nodeName,
y)!==false)if(k._setup)k._setup.call(q,u);else{q.readyState=4;q.dispatchEvent("loadedmetadata");q.dispatchEvent("loadeddata");q.dispatchEvent("canplaythrough")}else setTimeout(function(){q.dispatchEvent("error")},0);t=new h.p.init(q,u);if(k._teardown)t.destroy=o(t.destroy,function(){k._teardown.call(q,u)});return t};s.canPlayType=k._canPlayType=k._canPlayType||h.nop;h[n]=h.player.registry[n]=s}};h.player.registry={};h.player.defineProperty=Object.defineProperty||function(n,k,s){n.__defineGetter__(k,
s.get||h.nop);n.__defineSetter__(k,s.set||h.nop)};h.player.playerQueue=function(){var n=[],k=false;return{next:function(){k=false;n.shift();n[0]&&n[0]()},add:function(s){n.push(function(){k=true;s&&s()});!k&&n[0]()}}};h.smart=function(n,k,s){var t=typeof n==="string"?h.dom.find(n):n,y,u,F,z,G,H="HTMLVimeoVideoElement HTMLSoundCloudAudioElement HTMLNullVideoElement".split(" ");if(t){k=typeof k==="string"?[k]:k;n=0;for(G=k.length;n<G;n++){y=k[n];for(u=0;u<H.length;u++)if((z=h[H[u]])&&z._canPlaySrc(y)===
"probably"){F=z(t);k=h(F,s);setTimeout(function(){F.src=y},0);return k}for(var A in h.player.registry)if(h.player.registry.hasOwnProperty(A))if(h.player.registry[A].canPlayType(t.nodeName,y))return h[A](t,y,s)}A=h.guid("popcorn-video-");u=document.createElement("div");u.style.width="100%";u.style.height="100%";t.appendChild(u);H='<video id="'+A+'" preload=auto autobuffer>';n=0;for(G=k.length;n<G;n++)H+='<source src="'+k[n]+'">';H+="</video>";u.innerHTML=H;s&&s.events&&s.events.error&&t.addEventListener("error",
s.events.error,false);return h("#"+A,s)}else h.error("Specified target `"+n+"` was not found.")}})(Popcorn);
